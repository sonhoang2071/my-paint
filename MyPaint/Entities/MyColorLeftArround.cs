...
{
    internal class MyColorLeftArround:MyLeftArround
    {
        public Color brColor;
        public MyColorLeftArround(Point sPoint, Point ePoint, int borderWidth, Color borderColor, Color fillColor):base(sPoint, ePoint, borderWidth, borderColor)
        {
            this.sPoint = sPoint;
            this.width = ePoint.X;
