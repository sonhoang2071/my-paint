...
{
    internal class MyPatternPentagon:MyPentagon
    {
        public Color brColor;
        public MyPatternPentagon(Point startPoint, Point endPoint, int borderWidth, Color borderColor, Color fillColor) : base(startPoint, endPoint, borderWidth, borderColor)
        {
