...
{
    internal class MyColorUpArrow:MyUpArrow
    {
        public Color brColor;
        public MyColorUpArrow(Point sPoint, Point ePoint, int borderWidth, Color borderColor, Color fillColor):base(sPoint, ePoint, borderWidth, borderColor)
        {
            this.sPoint = sPoint;
            this.width = ePoint.X;
