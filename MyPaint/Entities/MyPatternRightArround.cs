...
{
    internal class MyPatternRightArround:MyRightArround
    {
        public Color brColor;
        public MyPatternRightArround(Point sPoint, Point ePoint, int borderWidth, Color borderColor, Color fillColor) : base(sPoint, ePoint, borderWidth, borderColor)
        {
            this.sPoint = sPoint;
            this.width = ePoint.X;
