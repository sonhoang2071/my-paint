...
{
    internal class MyPatternRoundedRectangle:MyRoundedRectangle
    {
        public Color brColor;
        public MyPatternRoundedRectangle(Point sPoint, Point ePoint, int borderWidth, Color borderColor, Color fillColor) : base(sPoint, ePoint, borderWidth, borderColor)
        {
            this.sPoint = sPoint;
            this.ePoint = ePoint;
