...
{
    internal class MyColorDownArrow:MyDownArrow
    {
        public Color brColor;
        public MyColorDownArrow(Point sPoint, Point ePoint, int borderWidth, Color borderColor, Color fillColor):base(sPoint, ePoint, borderWidth, borderColor)
        {
            this.sPoint = sPoint;
            this.width = ePoint.X;
