...
{
    internal class MyPatternUpArrow:MyUpArrow
    {
        public Color brColor;
        public MyPatternUpArrow(Point sPoint, Point ePoint, int borderWidth, Color borderColor, Color fillColor) : base(sPoint, ePoint, borderWidth, borderColor)
        {
            this.sPoint = sPoint;
            this.width = ePoint.X;
